...
String auditActionLabel(String action) => switch (action) {
      ...
      AuditAction.billingAnchorChanged => 'Billing day changed',
      AuditAction.billingDiscrepancyFound => 'Payments need checking',
      AuditAction.memberFeeChanged => 'Member fee changed',
      AuditAction.planPriceChanged => 'Plan price changed',
